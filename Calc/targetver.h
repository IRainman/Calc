...
#define WINVER 0x410//0x0600           // Выберите значение, указывающее на другие версии Windows.
#endif

#ifndef _WIN32_WINNT            // Указывает, что минимальной требуемой платформой является Windows Vista.
#define _WIN32_WINNT 0x0500// 0x0410     // Выберите значение, указывающее на другие версии Windows.
#endif
...
#define _WIN32_IE 0x0400//0x0700        // Выберите значение, указывающее на другие версии Internet Explorer.
#endif
